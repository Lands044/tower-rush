...
const V = class me {
    ...
    addToBatch(e, t) {
        if (this._activeBatch.name !== e.batcherName) {
            ...
            r || (r = this._activeBatches[e.batcherName] = me.getBatcher(e.batcherName),
                r.begin()),
                this._activeBatch = r
        }
    ...
    buildEnd(e) {
        ...
        for (const r in t) {
            const s = t[r]
                , a = s.geometry;
            a.indexBuffer.setDataWithSize(s.indexBuffer, s.indexSize, !0),
                a.buffers[0].setDataWithSize(s.attributeBuffer.float32View, s.attributeSize, !1)
        }
    }
    upload(e) {
        ...
        for (const r in t) {
            const s = t[r]
                , a = s.geometry;
            s.dirty && (s.dirty = !1,
                a.buffers[0].update(s.attributeSize * 4))
        }
    }
    execute(e) {
...
V._availableBatchers = Object.create(null);
let ge = V;
        ...
        if (e.action === "pushMaskBegin") {
            ...
            if (s.inverse = e.inverse,
                ...
                const i = t.renderTarget.renderTarget.colorTexture.source
                    , o = y.getOptimalTexture(a.width, a.height, i._resolution, i.antialias);
                ...
                const l = s.sprite;
                l.texture = o,
                    l.worldTransform.tx = a.minX,
                    l.worldTransform.ty = a.minY,
            ...
            r && (t.type === H.WEBGL && t.renderTarget.finishRenderPass(),
                t.renderTarget.pop(),
            ...
            r && y.returnTexture(s.filterTexture),
                w.return(s.filterEffect)
        }
    }
    destroy() {
        this._renderer = null,
...
class ve {
    ...
    push(e, t, r) {
        ...
        i !== this._currentColor && (this._currentColor = i,
            r.add({
...
class xe {
    ...
    push(e, t, r) {
        ...
        i.renderPipes.batch.break(r),
            i.renderPipes.blendMode.setBlendMode(a.mask, "none", r),
            r.add({
    ...
    pop(e, t, r) {
        ...
        a.renderPipes.batch.break(r),
            a.renderPipes.blendMode.setBlendMode(s.mask, "none", r),
            r.add({
                renderPipeId: "stencilMask",
                action: "popMaskBegin",
                inverse: t._maskOptions.inverse,
    ...
    execute(e) {
        ...
        e.action === "pushMaskBegin" ? (r.renderTarget.ensureDepthStencil(),
            r.stencil.setStencilMode(p.RENDERING_MASK_ADD, a),
            a++,
            r.colorMask.setMask(0)) : e.action === "pushMaskEnd" ? (e.inverse ? r.stencil.setStencilMode(p.INVERSE_MASK_ACTIVE, a) : r.stencil.setStencilMode(p.MASK_ACTIVE, a),
                r.colorMask.setMask(15)) : e.action === "popMaskBegin" ? (r.colorMask.setMask(0),
                    a !== 0 ? r.stencil.setStencilMode(p.RENDERING_MASK_REMOVE, a) : (r.renderTarget.clear(null, G.STENCIL),
                        r.stencil.setStencilMode(p.DISABLED, a)),
                    a--) : e.action === "popMaskEnd" && (e.inverse ? r.stencil.setStencilMode(p.INVERSE_MASK_ACTIVE, a) : r.stencil.setStencilMode(p.MASK_ACTIVE, a),
                        r.colorMask.setMask(15)),
            this._maskStackHash[s] = a
    }
    destroy() {
        this._renderer = null,
...
function Dt(n, e) {
    for (const t in n.attributes) {
        const r = n.attributes[t]
            , s = e[t];
        s ? (r.format ?? (r.format = s.format),
            r.offset ?? (r.offset = s.offset),
            r.instance ?? (r.instance = s.instance)) : W(`Attribute ${t} is not present in the shader, but is present in the geometry. Unable to infer attribute details.`)
    }
    ot(n)
}
function ot(n) {
    const { buffers: e, attributes: t } = n
        , r = {}
        , s = {};
    for (const a in e) {
        const i = e[a];
...
class Et {
    ...
    _initUniformGroup(e) {
        ...
        if (!r) {
            const s = Object.keys(e.uniformStructures).map(o => e.uniformStructures[o])
                , a = this._adaptor.createUboElements(s)
                , i = this._generateUboSync(a.uboElements);
    ...
    syncUniformGroup(e, t, r) {
        ...
        return t || (t = e.buffer.data,
            a = e.buffer.dataInt32),
            r || (r = 0),
            s.syncFunction(e.uniforms, t, a, r),
            !0
    }
...
function Ot(n, e, t, r) {
    ...
    for (let o = 0; o < n.length; o++) {
        ...
        for (let f = 0; f < M.length; f++)
            if (M[f].test(l.data)) {
                c = l.offset / 4,
                    s.push(`name = "${d}";`, `offset += ${c - a};`, M[f][e] || M[f].ubo),
                    h = !0;
                break
            }
        if (!h)
...
const ye = class Te {
    constructor(e = {}) {
        ...
        this.colorTexture.source.on("resize", this.onSourceResize, this),
            (e.depthStencilTexture || this.stencil) && (e.depthStencilTexture instanceof m || e.depthStencilTexture instanceof T ? this.depthStencilTexture = e.depthStencilTexture.source : this.ensureDepthStencilTexture())
    }
    get size() {
        const e = this._size;
    ...
    resize(e, t, r = this.resolution, s = !1) {
        this.dirtyId++,
            this.colorTextures.forEach((a, i) => {
...
class Lt {
    constructor(e) {
        this.rootViewPort = new P,
            this.viewport = new P,
            this.onRenderTargetChange = new je("onRenderTargetChange"),
    ...
    renderStart({ target: e, clear: t, clearColor: r, frame: s }) {
        ...
        this._renderTargetStack.length = 0,
            ...
            this.renderingToScreen = dt(this.rootRenderTarget),
            (i = (a = this.adaptor).prerender) == null || i.call(a, this.rootRenderTarget)
    }
    postrender() {
        var e, t;
    ...
    bind(e, t = !0, r, s) {
        const a = this.getRenderTarget(e)
            , i = this.renderTarget !== a;
        this.renderTarget = a,
            this.renderSurface = e;
        const o = this.getGpuRenderTarget(a);
        (a.pixelWidth !== o.width || a.pixelHeight !== o.height) && (this.adaptor.resizeGpuRenderTarget(a),
            o.width = a.pixelWidth,
            o.height = a.pixelHeight);
        const l = a.colorTexture
            , d = this.viewport
            , h = l.pixelWidth
            , c = l.pixelHeight;
        if (!s && e instanceof m && (s = e.frame),
            s) {
            const f = l._resolution;
            d.x = s.x * f + .5 | 0,
                d.y = s.y * f + .5 | 0,
                d.width = s.width * f + .5 | 0,
                d.height = s.height * f + .5 | 0
        } else
            d.x = 0,
                d.y = 0,
                d.width = h,
                d.height = c;
        return ut(this.projectionMatrix, 0, 0, d.width / l.resolution, d.height / l.resolution, !a.isRoot),
            this.adaptor.startRenderPass(a, t, r, d),
            i && this.onRenderTargetChange.emit(a),
            a
    }
    clear(e, t = G.ALL, r) {
    ...
    copyToTexture(e, t, r, s, a) {
        ...
        return s.width = Math.min(s.width, i - r.x),
            s.height = Math.min(s.height, o - r.y),
            this.adaptor.copyToTexture(e, t, r, s, a)
    }
    ensureDepthStencil() {
    ...
    _initRenderTarget(e) {
        let t = null;
        return A.test(e) && (e = be(e).source),
            e instanceof D ? t = e : e instanceof T && (t = new D({
                colorTextures: [e]
            }),
                e.source instanceof A && (t.isRoot = !0),
                e.once("destroy", () => {
                    t.destroy(),
...
class Ce {
    ...
    _addRenderableDirect(e, t) {
        this._renderer.renderPipes.batch.break(t),
            e._batchableRenderGroup && (w.return(e._batchableRenderGroup),
    ...
    _executeCacheAsTexture(e) {
        if (e.textureNeedsUpdate) {
            ...
            const t = ct.identity().translate(-e._textureBounds.x, -e._textureBounds.y);
            this._renderer.renderTarget.push(e.texture, !0, null, e.texture.frame),
                ...
                E(e, this._renderer.renderPipes),
...
function ft(n) {
    ...
    if (n.renderGroupParent) {
        ...
        n.worldTransform.appendFrom(e.relativeGroupTransform, r.worldTransform),
            n.worldColor = de(e.groupColor, r.worldColor),
            t = e.groupAlpha * r.worldAlpha
    } else
        n.worldTransform.copyFrom(e.localTransform),
            n.worldColor = e.localColor,
            t = e.localAlpha;
    t = t < 0 ? 0 : t > 1 ? 1 : t,
        n.worldAlpha = t,
        n.worldColorAlpha = n.worldColor + ((t * 255 | 0) << 24)
}
function Se(n, e, t) {
    if (e === n.updateTick)
        return;
    ...
    const s = n.parent;
    if (s && !s.renderGroup ? (t |= n._updateFlags,
        n.relativeGroupTransform.appendFrom(r, s.relativeGroupTransform),
        t & ae && ne(n, s, t)) : (t = n._updateFlags,
            n.relativeGroupTransform.copyFrom(r),
            t & ae && ne(n, ht, t)),
        !n.renderGroup) {
        const a = n.children
            , i = a.length;
...
function ne(n, e, t) {
    if (t & he) {
        n.groupColor = de(n.localColor, e.groupColor);
        let r = n.localAlpha * e.groupAlpha;
        r = r < 0 ? 0 : r > 1 ? 1 : r,
            n.groupAlpha = r,
            n.groupColorAlpha = n.groupColor + ((r * 255 | 0) << 24)
    }
    t & fe && (n.groupBlendMode = n.localBlendMode === "inherit" ? e.groupBlendMode : n.localBlendMode),
        t & ce && (n.globalDisplayStatus = n.localDisplayStatus & e.globalDisplayStatus),
        n._updateFlags = 0
}
function pt(n, e) {
    ...
    for (let s = 0; s < n.childrenRenderablesToUpdate.index; s++) {
        const a = t[s];
        if (r = e[a.renderPipeId].validateRenderable(a),
            r)
            break
    }
    return n.structureDidChange = r,
        r
}
const mt = new g;
class Re {
    ...
    render({ container: e, transform: t }) {
        ...
        const a = this._renderer
            , i = mt;
        t && (i.copyFrom(e.renderGroup.localTransform),
    ...
    _updateCachedRenderGroups(e, t) {
        ...
        if (e.invalidateMatrices(),
            ...
            if (e.textureNeedsUpdate) {
                ...
                const a = this._renderer
                    , i = e.textureOptions.resolution || a.view.resolution
                    , o = e.textureOptions.antialias ?? a.view.antialias
                    , l = e.textureOptions.scaleMode ?? "linear"
                    , d = y.getOptimalTexture(r.width, r.height, i, o);
                d._source.style = new $e({
                    scaleMode: l
                }),
                    e.texture = d,
                    e._textureBounds || (e._textureBounds = new L),
    ...
    _updateRenderGroups(e) {
        ...
        if (e.runOnRender(t),
            ...
            e.structureDidChange ? O(e.childrenRenderablesToUpdate.list, 0) : pt(e, r),
            Me(e),
...
const N = class Pe {
    ...
    set color(e) {
        I.shared.setValue(e).alpha < 1 && this._backgroundColor.alpha === 1 && W("Cannot set a transparent background on an opaque canvas. To enable transparency, set backgroundAlpha < 1 when initializing your Application."),
...
class Ue {
    ...
    _ensureFilterEffect(e) {
        ...
        return t || (t = this._filterHash[e] = new ue,
            t.filters = [new k[e]]),
            t
    }
...
const B = {
    ...
    , j = class Be {
        ...
        async base64(e) {
            e = this._normalizeOptions(e, Be.defaultImageOptions);
        ...
        pixels(e) {
            ...
            const t = e.target
                ...
                , a = r.texture.getPixels(s);
            return t instanceof U && s.destroy(!0),
                a
        }
        texture(e) {
        ...
        log(e) {
            ...
            const a = ["font-size: 1px;", `padding: ${t}px 300px;`, `background: url(${s}) no-repeat;`, "background-size: contain;"].join(" ");
            console.log("%c ", a)
        }
        destroy() {
            this._renderer = null
...
const $ = class Ae {
    ...
    set enabled(e) {
        this.enabled !== e && (e ? this._handler = this._renderer.scheduler.repeat(() => {
            ...
            , this._frequency, !1) : (this._renderer.scheduler.cancel(this._handler),
                this._handler = 0))
    }
    ...
    postrender() {
        !this._ready || !this.enabled || (this.run(),
            this._ready = !1)
    }
    ...
    addResource(e, t) {
        ...
        if (e._gcLastUsed !== -1) {
            e._gcLastUsed = this.now,
                (s = e._onTouch) == null || s.call(e, this.now);
            return
        }
        ...
        e._gcData = {
            ...
            e._gcLastUsed = this.now,
            (a = e._onTouch) == null || a.call(e, this.now),
    ...
    removeResource(e) {
        ...
        if (!t)
            return;
        const r = t.index
            , s = this._managedResources.length - 1;
        if (r !== s) {
            const a = this._managedResources[s];
            this._managedResources[r] = a,
                a._gcData.index = r
        }
    ...
    updateRenderableGCTick(e, t) {
        ...
        const r = e.renderGroup ?? e.parentRenderGroup
            , s = ((a = r == null ? void 0 : r.instructionSet) == null ? void 0 : a.gcTick) ?? -1;
        ((r == null ? void 0 : r.gcTick) ?? 0) === s && (e._gcLastUsed = t,
            (i = e._onTouch) == null || i.call(e, t))
    }
    runOnResource(e, t, r) {
        const s = e._gcData;
        return s.type === "renderable" && this.updateRenderableGCTick(e, t),
            t - e._gcLastUsed < this.maxUnusedTime || !e.autoGarbageCollect ? (this._managedResources[r] = e,
                s.index = r,
                r++) : (e.unload(),
                    e._gcData = null,
                    e._gcLastUsed = -1,
    ...
    runOnHash(e, t) {
        var d;
        const { context: r, hash: s, type: a } = e
            , i = r[s];
        let o = null
            , l = 0;
        for (const h in i) {
            ...
            if (c === null) {
                l++,
                    l === 1e4 && !o && (o = this._createHashClone(i, h));
                continue
            }
            if (c._gcLastUsed === -1) {
                c._gcLastUsed = t,
                    (d = c._onTouch) == null || d.call(c, t),
                    o && (o[h] = c);
                continue
            }
            a === "renderable" && this.updateRenderableGCTick(c, t),
                !(t - c._gcLastUsed < this.maxUnusedTime) && c.autoGarbageCollect ? (o || (l + 1 !== 1e4 ? (i[h] = null,
                    l++) : o = this._createHashClone(i, h)),
                    c.unload(),
                    c._gcData = null,
                    c._gcLastUsed = -1) : o && (o[h] = c)
        }
        o && (r[s] = o)
    }
    destroy() {
...
class Ie {
    ...
    bind({ size: e, projectionMatrix: t, worldTransformMatrix: r, worldColor: s, offset: a }) {
        ...
        h.uProjectionMatrix = l.projectionMatrix,
            ...
            tt(l.worldColor, h.uWorldColorAlpha, 0),
            d.update();
        let c;
        this._renderer.renderPipes.uniformBatch ? c = this._renderer.renderPipes.uniformBatch.getUniformBindGroup(d, !1) : (c = this._bindGroupPool.pop() || new Je,
    ...
    pop() {
        this._currentGlobalUniformData = this._globalUniformDataStack[--this._stackIndex - 1],
            this._renderer.type === H.WEBGL && this._currentGlobalUniformData.bindGroup.resources[0].update()
    }
    get bindGroup() {
...
class De {
    ...
    destroy() {
        te.system.remove(this._update, this),
...
function kt(n) {
    if (!ie) {
        if (z.get().getNavigator().userAgent.toLowerCase().indexOf("chrome") > -1) {
            const e = [`%c  %c  %c  %c  %c PixiJS %c v${re} (${n}) http://www.pixijs.com/
...
`, "background: #E72264; padding:5px 0;", "background: #6CA2EA; padding:5px 0;", "background: #B5D33D; padding:5px 0;", "background: #FED23F; padding:5px 0;", "color: #FFFFFF; background: #E72264; padding:5px 0;", "color: #E72264; background: #FFFFFF; padding:5px 0;"];
            ...
            globalThis.console && globalThis.console.log(`PixiJS ${re} - ${n} - http://www.pixijs.com/`);
        ie = !0
    }
}
class K {
    ...
    init(e) {
        if (e.hello) {
            ...
            this._renderer.type === H.WEBGL && (t += ` ${this._renderer.context.webGLVersion}`),
                kt(t)
        }
    }
}
...
const Y = class Ee {
    ...
    run() {
        ...
        for (let i = 0; i < t.length; i++) {
            ...
            const l = o.renderGroup ?? o.parentRenderGroup
                , d = ((a = l == null ? void 0 : l.instructionSet) == null ? void 0 : a.gcTick) ?? -1;
            if (((l == null ? void 0 : l.gcTick) ?? 0) === d && (o._lastUsed = e),
                e - o._lastUsed > this.maxUnusedTime) {
                if (!o.destroyed) {
                    const h = r;
                    l && (l.structureDidChange = !0),
                        h[o.renderPipeId].destroyRenderable(o)
                }
                o._lastUsed = -1,
                    s++,
                    o.off("destroyed", this._removeRenderable, this)
            } else
                t[i - s] = o
        }
        t.length -= s
...
const J = class R {
    ...
    init(e) {
        e.textureGCActive !== R.defaultOptions.textureGCActive && (this.active = e.textureGCActive),
            e.textureGCMaxIdle !== R.defaultOptions.textureGCMaxIdle && (this.maxIdle = e.textureGCMaxIdle),
            e.textureGCCheckCountMax !== R.defaultOptions.textureGCCheckCountMax && (this.checkCountMax = e.textureGCCheckCountMax)
    }
    run() {
        v("8.15.0", "TextureGCSystem.run is deprecated, please use the GCSystem instead."),
...
const X = class Oe {
    ...
    init(e) {
        e = {
            ...
            e.view && (v(Xe, "ViewSystem.view has been renamed to ViewSystem.canvas"),
                e.canvas = e.view),
            this.screen = new P(0, 0, e.width, e.height),
            this.canvas = e.canvas || z.get().createCanvas(),
            this.antialias = !!e.antialias,
            this.texture = be(this.canvas, e),
            this.renderTarget = new D({
...
let Pt = X;
const Wt = [gt, Ie, K, Pt, Re, yt, wt, Ge, _t, Qe, Rt, De]
    , zt = [Ue, ge, we, Ce, _e, xe, ve, ke];
export { Ht as B, b as G, Lt as R, Wt as S, Et as U, zt as a, lt as b, Ot as c, M as d, Dt as e, It as f, At as t, Ft as u };
