import { E as d, c as U, B, w as m, D as S, L as $, a as Ae, S as F, v as b, a6 as Ne, m as z, a7 as ye, d as p, Q as H, l as A, k as N, n as O, M as Y, a8 as q, a9 as Ce, aa as Z, ab as De, ac as Ie, A as Ge, R as Ue, e as v } from "./index-qssFTiEP.js";
import { S as P, b as Q } from "./colorToUniform-BmEsojv1.js";
import { e as Fe, G as Oe, c as Pe, b as Me, U as Le, R as we, B as J, d as y, f as He, S as ke, a as Ve } from "./SharedSystems-DaFJN6Ic.js";
class ee {
    constructor() {
        this._tempState = P.for2d(),
            this._didUploadHash = {}
    }
    init(e) {
...
var x = (t => (t[t.ELEMENT_ARRAY_BUFFER = 34963] = "ELEMENT_ARRAY_BUFFER",
...
class te {
    ...
    getGlBuffer(e) {
        return e._gcLastUsed = this._renderer.gc.now,
    ...
    bindBufferBase(e, r) {
        const { _gl: s } = this;
        this._boundBufferBases[r] !== e && (this._boundBufferBases[r] = e,
    ...
    freeLocationForBufferBase(e) {
        ...
        for (; s < 2;) {
            n >= this._maxBindings && (n = this._minBaseLocation,
                s++);
        ...
        return r = n,
            ...
            s >= 2 ? -1 : (e._lastBindCallId = this._bindCallId,
    ...
    updateBuffer(e) {
        ...
        return n ? s.byteLength >= n.byteLength ? r.bufferSubData(s.type, 0, n, 0, e._updateSize / n.BYTES_PER_ELEMENT) : (s.byteLength = n.byteLength,
            r.bufferData(s.type, n, i)) : (s.byteLength = e.descriptor.size,
    ...
    createGLBuffer(e) {
        ...
        return e._gpuData[this._renderer.uid] = n,
...
const M = class re {
    ...
    init(e) {
        ...
        if (e.context && r && (m("Renderer created with both a context and multiview enabled. Disabling multiView as both cannot work together."),
            r = !1),
            r ? this.canvas = S.get().createCanvas(this._renderer.canvas.width, this._renderer.canvas.height) : this.canvas = this._renderer.view.canvas,
            e.context)
    ...
    ensureCanvasSize(e) {
        ...
        const { canvas: r } = this;
        (r.width < e.width || r.height < e.height) && (r.width = Math.max(e.width, e.width),
    ...
    createContext(e, r) {
        let s;
        const n = this.canvas;
        if (e === 2 && (s = n.getContext("webgl2", r)),
            !s && (s = n.getContext("webgl", r),
                !s))
    ...
    validateContext(e) {
        ...
        s.uint32Indices = n || !!i.uint32ElementIndex,
            ...
            s.msaa = n,
            s.uint32Indices || m("Provided WebGL context does not support 32 index buffer, large scenes may not render correctly")
    }
}
    ;
M.extension = {
...
var I = (t => (t[t.RGBA = 6408] = "RGBA",
    ...
    t))(I || {})
    , se = (t => (t[t.TEXTURE_2D = 3553] = "TEXTURE_2D",
        ...
        t))(se || {})
    , f = (t => (t[t.UNSIGNED_BYTE = 5121] = "UNSIGNED_BYTE",
...
class ne {
    ...
    contextChange() {
        ...
        r && (e.createVertexArray = () => r.createVertexArrayOES(),
    ...
    initGeometryVao(e, r, s = !0) {
        ...
        this._renderer.shader._getProgramData(r),
            this.checkCompatibility(e, r);
        const a = this.getSignature(e, r)
            , o = new $e;
        e._gpuData[this._renderer.uid] = o,
            this._managedGeometries.add(e);
        const u = o.vaoCache;
        let c = u[a];
        if (c)
            return u[r._key] = c,
    ...
    onGeometryUnload(e, r = !1) {
        ...
        if (!r)
            for (const i in n)
                this._activeVao !== n[i] && this.resetState(),
                    this.gl.deleteVertexArray(n[i])
    }
    destroyAll(e = !1) {
    ...
    activateVao(e, r) {
        ...
        for (const u in i) {
            ...
            if (l) {
                ...
                const T = $(c.format)
                    , w = je(c.format);
                if (((o = l.format) == null ? void 0 : o.substring(1, 4)) === "int" ? s.vertexAttribIPointer(E, T.size, w, c.stride, c.offset) : s.vertexAttribPointer(E, T.size, w, T.normalised, c.stride, c.offset),
                    c.instance)
                    if (this.hasInstance) {
    ...
    draw(e, r, s, n) {
        const { gl: i } = this._renderer
            ...
            , o = Ke[e || a.topology];
        if (n ?? (n = a.instanceCount),
            a.indexBuffer) {
            const u = a.indexBuffer.data.BYTES_PER_ELEMENT
                , c = u === 2 ? i.UNSIGNED_SHORT : i.UNSIGNED_INT;
    ...
    , L = class ie {
        ...
        init(e = {}) {
            ...
            this.useBackBuffer = r,
                this._antialias = s,
                this._renderer.context.supports.msaa || (m("antialiasing, is not supported on when using the back buffer"),
                    this._antialias = !1),
                this._state = P.for2d();
            const n = new Ae({
                vertex: `
        ...
        renderStart(e) {
            ...
            if (this._useBackBufferThisRender = this.useBackBuffer && !!r.isRoot,
...
class oe {
    ...
    draw(e) {
        const r = this._renderer
            , { geometry: s, shader: n, state: i, skipSync: a, topology: o, size: u, start: c, instanceCount: _ } = e;
        r.shader.bind(n, a),
            r.geometry.bind(s, r.shader._activeProgram),
            i && r.state.set(i),
            r.geometry.draw(o, u, c, _ ?? s.instanceCount)
    }
    destroy() {
        this._renderer = null
    }
...
class ce {
    ...
    contextChange() {
        ...
        this.maxTextures = e.getParameter(e.MAX_TEXTURE_IMAGE_UNITS),
            this.maxBatchableTextures = ye(this.maxTextures, e);
...
class ue {
    ...
    setStencilMode(e, r) {
        ...
        this._stencilCache.enabled || (this._stencilCache.enabled = !0,
            ...
            (e !== a.stencilMode || a.stencilReference !== r) && (a.stencilMode = e,
...
function Qe(t, e) {
    const r = Math.max(_e[t.data.type] / 16, 1)
...
class et {
    ...
    contextChange() {
        ...
        for (let r = 1; r <= 16; r++)
            this._drawBuffersCache[r] = Array.from({
                length: r
    ...
    copyToTexture(e, r, s, n, i) {
        const a = this._renderTargetSystem
            , o = this._renderer
            , u = a.getGpuRenderTarget(e)
            , c = o.gl;
        return this.finishRenderPass(e),
            c.bindFramebuffer(c.FRAMEBUFFER, u.resolveTargetFramebuffer),
            o.texture.bind(r, 0),
            c.copyTexSubImage2D(c.TEXTURE_2D, 0, i.x, i.y, s.x, s.y, n.width, n.height),
            r
    }
    startRenderPass(e, r = !0, s, n) {
        ...
        let u = n.y;
        e.isRoot && (u = a.pixelHeight - n.height - n.y),
            e.colorTextures.forEach(h => {
                this._renderer.texture.unbind(h)
            }
            );
        const c = this._renderer.gl;
        c.bindFramebuffer(c.FRAMEBUFFER, o.framebuffer),
            e.colorTextures.length > 1 && this._setDrawBuffers(e, c);
        const _ = this._viewPortCache;
        (_.x !== n.x || _.y !== u || _.width !== n.width || _.height !== n.height) && (_.x = n.x,
            _.y = u,
            _.width = n.width,
            _.height = n.height,
            c.viewport(n.x, u, n.width, n.height)),
    ...
    initGpuRenderTarget(e) {
        const s = this._renderer.gl
            , n = new qe;
        return e.colorTexture instanceof A ? (this._renderer.context.ensureCanvasSize(e.colorTexture.resource),
            n.framebuffer = null,
            n) : (this._initColor(e, n),
                s.bindFramebuffer(s.FRAMEBUFFER, null),
                n)
    }
    destroyGpuRenderTarget(e) {
        const r = this._renderer.gl;
        e.framebuffer && (r.deleteFramebuffer(e.framebuffer),
            e.framebuffer = null),
            e.resolveTargetFramebuffer && (r.deleteFramebuffer(e.resolveTargetFramebuffer),
                e.resolveTargetFramebuffer = null),
            e.depthStencilRenderBuffer && (r.deleteRenderbuffer(e.depthStencilRenderBuffer),
    ...
    resizeGpuRenderTarget(e) {
        if (e.isRoot)
            return;
        const s = this._renderTargetSystem.getGpuRenderTarget(e);
        this._resizeColor(e, s),
            (e.stencil || e.depth) && this._resizeStencil(s)
    }
    _initColor(e, r) {
        const s = this._renderer
            , n = s.gl
            , i = n.createFramebuffer();
        if (r.resolveTargetFramebuffer = i,
            n.bindFramebuffer(n.FRAMEBUFFER, i),
            r.width = e.colorTexture.source.pixelWidth,
            r.height = e.colorTexture.source.pixelHeight,
            e.colorTextures.forEach((o, u) => {
                const c = o.source;
                c.antialias && (s.context.supports.msaa ? r.msaa = !0 : m("[RenderTexture] Antialiasing on textures is not supported in WebGL1")),
                    s.texture.bindSource(c, 0);
                const h = s.texture.getGlSource(c).texture;
                n.framebufferTexture2D(n.FRAMEBUFFER, n.COLOR_ATTACHMENT0 + u, 3553, h, 0)
            }
            ),
            r.msaa) {
        ...
        if (r.width = s.pixelWidth,
            ...
            i.bindFramebuffer(i.FRAMEBUFFER, a),
                e.colorTextures.forEach((o, u) => {
                    ...
                    const h = n.texture.getGlSource(c).internalFormat
                        , l = r.msaaRenderBuffer[u];
                    i.bindRenderbuffer(i.RENDERBUFFER, l),
                        i.renderbufferStorageMultisample(i.RENDERBUFFER, 4, h, c.pixelWidth, c.pixelHeight),
                        i.framebufferRenderbuffer(i.FRAMEBUFFER, i.COLOR_ATTACHMENT0 + u, i.RENDERBUFFER, l)
                }
                )
        }
    }
    ...
    _resizeStencil(e) {
        ...
        r.bindRenderbuffer(r.RENDERBUFFER, e.depthStencilRenderBuffer),
            e.msaa ? r.renderbufferStorageMultisample(r.RENDERBUFFER, 4, r.DEPTH24_STENCIL8, e.width, e.height) : r.renderbufferStorage(r.RENDERBUFFER, this._renderer.context.webGLVersion === 2 ? r.DEPTH24_STENCIL8 : r.DEPTH_STENCIL, e.width, e.height)
    }
    prerender(e) {
    ...
    _setDrawBuffers(e, r) {
        const s = e.colorTextures.length
            , n = this._drawBuffersCache[s];
...
`)
        , i = {}
        , a = n.map(c => parseFloat(c.replace(/^ERROR\: 0\:([\d]+)\:.*$/, "$1"))).filter(c => c && !i[c] ? (i[c] = !0,
            !0) : !1)
        , o = [""];
    a.forEach(c => {
        r[c - 1] = `%c${r[c - 1]}%c`,
...
function ct(t, e, r, s) {
    t.getProgramParameter(e, t.LINK_STATUS) || (t.getShaderParameter(r, t.COMPILE_STATUS) || W(t, r),
...
function ut(t, e) {
    ...
    i && (typeof t.transformFeedbackVaryings != "function" ? m("TransformFeedback is not supported but TransformFeedbackVaryings are given.") : t.transformFeedbackVaryings(n, i.names, i.bufferMode === "separate" ? t.SEPARATE_ATTRIBS : t.INTERLEAVED_ATTRIBS)),
        t.linkProgram(n),
        t.getProgramParameter(n, t.LINK_STATUS) || ct(t, n, r, s),
        e._attributeData = it(n, t, !/^[ \t]*#[ \t]*version[ \t]+300[ \t]+es[ \t]*$/m.test(e.vertex)),
        e._uniformData = ot(n, t),
        e._uniformBlockData = at(n, t),
        t.deleteShader(r),
        t.deleteShader(s);
    const a = {};
...
class me {
    ...
    bindUniformBlock(e, r, s = 0) {
        ...
        const o = e.buffer
            , u = n.updateBuffer(o)
            , c = n.freeLocationForBufferBase(u);
        if (a) {
            const { offset: h, size: l } = e;
            h === 0 && l === o.data.byteLength ? n.bindBufferBase(u, c) : n.bindBufferRange(u, c, h)
        } else
            n.getLastBindBaseLocation(u) !== c && n.bindBufferBase(u, c);
        const _ = this._activeProgram._uniformBlockData[r].index;
        i.uniformBlockBindings[s] !== c && (i.uniformBlockBindings[s] = c,
            this._renderer.gl.uniformBlockBinding(i.program, _, c))
    }
    _setProgram(e) {
    ...
    _createProgramData(e) {
        const r = e._key;
        return this._programDataHash[r] = ut(this._gl, e),
...
class Ee {
    ...
    updateUniformGroup(e, r, s) {
        ...
        (!e.isStatic || e._dirtyId !== n.uniformDirtyGroups[e.uid]) && (n.uniformDirtyGroups[e.uid] = e._dirtyId,
    ...
    _createUniformSyncFunction(e, r) {
        const s = this._uniformGroupSyncHash[e._signature] || (this._uniformGroupSyncHash[e._signature] = {})
            , n = this._getSignature(e, r._uniformData, "u");
        return this._cache[n] || (this._cache[n] = this._generateUniformsSync(e, r._uniformData)),
...
function lt(t) {
    ...
    if (e.normal = [t.ONE, t.ONE_MINUS_SRC_ALPHA],
        ...
        s && (e.min = [t.ONE, t.ONE, t.ONE, t.ONE, s.MIN_EXT, s.MIN_EXT],
    ...
    , be = class G {
        constructor(e) {
            this._invertFrontFace = !1,
                ...
                this._blendEq = !1,
                this.map = [],
                this.map[dt] = this.setBlend,
                this.map[mt] = this.setOffset,
                this.map[Et] = this.setCullFace,
                this.map[bt] = this.setDepthTest,
                this.map[St] = this.setFrontFace,
                this.map[pt] = this.setDepthMask,
                this.checks = [],
                this.defaultState = P.for2d(),
                e.renderTarget.onRenderTargetChange.add(this)
        }
        onRenderTargetChange(e) {
        ...
        setFrontFace(e) {
            ...
            this._glFrontFace !== r && (this._glFrontFace = r,
        ...
        setBlendMode(e) {
            ...
            r.length === 2 ? s.blendFunc(r[0], r[1]) : s.blendFuncSeparate(r[0], r[1], r[2], r[3]),
                r.length === 6 ? (this._blendEq = !0,
                    s.blendEquationSeparate(r[4], r[5])) : this._blendEq && (this._blendEq = !1,
...
const xt = {
    id: "buffer",
    upload(t, e, r) {
        e.width === t.width || e.height === t.height ? r.texSubImage2D(r.TEXTURE_2D, 0, 0, 0, t.width, t.height, e.format, e.type, t.resource) : r.texImage2D(e.target, 0, e.internalFormat, t.width, t.height, 0, e.format, e.type, t.resource),
            e.width = t.width,
            e.height = t.height
    }
}
    ...
    , Tt = {
        ...
        upload(t, e, r) {
            ...
            for (let a = 0; a < t.resource.length; a++) {
                ...
                i ? r.compressedTexImage2D(r.TEXTURE_2D, a, e.internalFormat, s, n, 0, o) : r.texImage2D(r.TEXTURE_2D, a, e.internalFormat, s, n, 0, e.format, e.type, o),
                    s = Math.max(s >> 1, 1),
                    n = Math.max(n >> 1, 1)
            }
        }
    ...
    , Se = {
        ...
        upload(t, e, r, s) {
            const n = e.width
                ...
                , u = t.resourceWidth
                , c = t.resourceHeight;
            u < a || c < o ? ((n !== a || i !== o) && r.texImage2D(e.target, 0, e.internalFormat, a, o, 0, e.format, e.type, null),
                s === 2 ? r.texSubImage2D(r.TEXTURE_2D, 0, 0, 0, u, c, e.format, e.type, t.resource) : r.texSubImage2D(r.TEXTURE_2D, 0, 0, 0, e.format, e.type, t.resource)) : n === a && i === o ? r.texSubImage2D(r.TEXTURE_2D, 0, 0, 0, e.format, e.type, t.resource) : s === 2 ? r.texImage2D(e.target, 0, e.internalFormat, a, o, 0, e.format, e.type, t.resource) : r.texImage2D(e.target, 0, e.internalFormat, e.format, e.type, t.resource),
                e.width = a,
                e.height = o
        }
    }
...
function K(t, e, r, s, n, i, a, o) {
    ...
    if (!o || t.addressModeU !== "repeat" || t.addressModeV !== "repeat" || t.addressModeW !== "repeat") {
        const c = D[a ? "clamp-to-edge" : t.addressModeU]
            , _ = D[a ? "clamp-to-edge" : t.addressModeV]
            , h = D[a ? "clamp-to-edge" : t.addressModeW];
        e[n](u, e.TEXTURE_WRAP_S, c),
            e[n](u, e.TEXTURE_WRAP_T, _),
            e.TEXTURE_WRAP_R && e[n](u, e.TEXTURE_WRAP_R, h)
    }
    if ((!o || t.magFilter !== "linear") && e[n](u, e.TEXTURE_MAG_FILTER, j[t.magFilter]),
        r) {
...
class pe {
    ...
    contextChange(e) {
        this._gl = e,
            this._mapFormatToInternalFormat || (this._mapFormatToInternalFormat = Ct(e, this._renderer.context.extensions),
                this._mapFormatToType = Dt(e),
                this._mapFormatToFormat = yt(e)),
    ...
    bind(e, r = 0) {
        const s = e.source;
        e ? (this.bindSource(s, r),
            this._useSeparateSamplers && this._bindSampler(s.style, r)) : (this.bindSource(null, r),
                this._useSeparateSamplers && this._bindSampler(null, r))
    }
    bindSource(e, r = 0) {
        const s = this._gl;
        if (e._gcLastUsed = this._renderer.gc.now,
    ...
    _bindSampler(e, r = 0) {
        const s = this._gl;
        if (!e) {
            this._boundSamplers[r] = null,
                s.bindSampler(r, null);
            return
        }
        const n = this._getGlSampler(e);
        this._boundSamplers[r] !== n && (this._boundSamplers[r] = n,
            s.bindSampler(r, n))
    }
    unbind(e) {
        const r = e.source
    ...
    _initSource(e) {
        const r = this._gl
            , s = new Rt(r.createTexture());
        if (s.type = this._mapFormatToType[e.format],
        ...
        return e._gpuData[this._renderer.uid] = s,
            this._managedTextures.add(e) && (e.on("update", this.onSourceUpdate, this),
    ...
    updateStyle(e, r) {
        ...
        s.bindTexture(s.TEXTURE_2D, n.texture),
            ...
            K(e.style, s, e.mipLevelCount > 1, this._renderer.context.extensions.anisotropicFiltering, "texParameteri", s.TEXTURE_2D, !this._renderer.context.supports.nonPowOf2wrapping && !e.isPowerOfTwo, r)
    }
    onSourceUnload(e, r = !1) {
        const s = e._gpuData[this._renderer.uid];
        s && (r || (this.unbind(e),
            this._gl.deleteTexture(s.texture)),
    ...
    onSourceUpdate(e) {
        ...
        this._premultiplyAlpha !== n && (this._premultiplyAlpha = n,
            r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL, n)),
            this._uploads[e.uploadMethodId] ? this._uploads[e.uploadMethodId].upload(e, s, r, this._renderer.context.webGLVersion) : r.texImage2D(r.TEXTURE_2D, 0, s.internalFormat, e.pixelWidth, e.pixelHeight, 0, s.format, s.type, null),
    ...
    _initSampler(e) {
        ...
        return this._glSamplers[e._resourceId] = s,
            K(e, r, this._boundTextures[this._activeTextureLocation].mipLevelCount > 1, this._renderer.context.extensions.anisotropicFiltering, "samplerParameteri", s, !1, !0),
    ...
    getPixels(e) {
        const r = e.source.resolution
            ...
            , a = new Uint8Array(It * n * i)
            , o = this._renderer
            , u = o.renderTarget.getRenderTarget(e)
            , c = o.renderTarget.getGpuRenderTarget(u)
            , _ = o.gl;
        return _.bindFramebuffer(_.FRAMEBUFFER, c.resolveTargetFramebuffer),
...
class ge {
    ...
    execute(e, r) {
        const s = r.context
            ...
            , i = e.renderer
            , a = i.graphicsContext
            , { batcher: o, instructions: u } = a.getContextRenderData(s);
...
const Gt = [...ke, fe, Ye, We, ce, te, pe, he, ne, Ee, me, oe, gt, ue, ae]
    , Ut = [...Ve]
    , Ft = [ee, Re, ge]
    , xe = []
    , ve = []
