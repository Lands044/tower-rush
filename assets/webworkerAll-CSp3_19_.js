import { E as f, U as We, T as J, G as he, a as fe, M as v, n as R, i as pe, I as b, v as P, a6 as me, R as X, w as L, H as ge, D as $, c as w, z as G, ad as Ye, ae as j, L as W, af as U, h as Z, B as F, S as q, $ as He, _ as Y, ag as Ke, p as xe, s as _e, a8 as ye, aa as Te, ah as be, q as Xe, t as $e, a9 as je, ab as qe, ac as Ne, ai as Qe, aj as Je, ak as Ze, al as H, am as et, an as tt, o as ve, a3 as ee, ao as te, ap as A, e as m, aq as rt } from "./index-qssFTiEP.js";
import { F as nt, S as M, c as z, a as at, b as st, B as Ce } from "./colorToUniform-BmEsojv1.js";
class Pe {
    static init(e) {
        Object.defineProperty(this, "resizeTo", {
            ...
            this.resize = () => {
                ...
                if (this._resizeTo === globalThis.window)
                    ...
                    const { clientWidth: n, clientHeight: a } = this._resizeTo;
                    t = n,
                        r = a
                }
...
class we {
    static init(e) {
        e = Object.assign({
            ...
            Object.defineProperty(this, "ticker", {
                ...
                set(t) {
                    this._ticker && this._ticker.remove(this.render, this),
                        this._ticker = t,
                        t && t.add(this.render, this, We.LOW)
                },
                get() {
                    return this._ticker
                }
            ...
            ,
            this._ticker = null,
            this.ticker = e.sharedTicker ? J.shared : new J,
...
function lt(i, e) {
    ...
    for (let r = 0; r < i.length; r++) {
        ...
        a != null && a.isCachedAsTexture ? e.matrix = ne.copyFrom(a.textureOffsetInverseTransform).append(n.worldTransform) : a != null && a._parentCacheAsTextureRenderGroup ? e.matrix = ne.copyFrom(a._parentCacheAsTextureRenderGroup.inverseWorldTransform).append(n.groupTransform) : e.matrix = n.worldTransform,
...
class Re {
    constructor(e) {
        this._filterStackIndex = 0,
            this._filterStack = [],
            this._filterGlobalUniforms = new R({
                uInputSize: {
            ...
            this._globalFilterBindGroup = new pe({}),
            this.renderer = e
    }
    ...
    push(e) {
        ...
        const u = n.bounds;
        if (this._calculateFilterArea(e, u),
            this._calculateFilterBounds(n, t.renderTarget.rootViewPort, o, s, 1),
            n.skip)
            return;
        const l = this._getPreviousFilterData()
            , h = this._findFilterResolution(s);
        let c = 0
            , d = 0;
        l && (c = l.bounds.minX,
            d = l.bounds.minY),
            this._calculateGlobalFrame(n, c, d, h, a.width, a.height),
            this._setupFilterTextures(n, u, t, l)
    }
    generateFilteredTexture({ texture: e, filters: t }) {
        ...
        if (o.addRect(e.frame),
            this._calculateFilterBounds(r, o.rectangle, s, a, 0),
            r.skip)
            return e;
        const u = a;
        this._calculateGlobalFrame(r, 0, 0, u, n.width, n.height),
            r.outputRenderSurface = b.getOptimalTexture(o.width, o.height, r.resolution, r.antialias),
            r.backTexture = P.EMPTY,
            r.inputTexture = e,
            this.renderer.renderTarget.finishRenderPass(),
            this._applyFiltersToTexture(r, !0);
        const d = r.outputRenderSurface;
        return d.source.alphaMode = "premultiplied-alpha",
            d
    }
    pop() {
        ...
        t.skip || (e.globalUniforms.pop(),
            ...
            t.blendRequired && b.returnTexture(t.backTexture),
            b.returnTexture(t.inputTexture))
    }
    getBackTexture(e, t, r) {
        const n = e.colorTexture.source._resolution
            , a = b.getOptimalTexture(t.width, t.height, n, !1);
        let s = t.minX
            , o = t.minY;
        r && (s -= r.minX,
            o -= r.minY),
    ...
    applyFilter(e, t, r, n) {
        const a = this.renderer
            , s = this._activeFilterData
            , u = s.outputRenderSurface === r
            , l = a.renderTarget.rootRenderTarget.colorTexture.source._resolution
            , h = this._findFilterResolution(l);
        let c = 0
            , d = 0;
        if (u) {
        ...
        this._updateFilterUniforms(t, r, s, c, d, h, u, n);
        const p = e.enabled ? e : this._getPassthroughFilter();
        this._setupBindGroupsAndRender(p, t, a)
    }
    calculateSpriteMatrix(e, t) {
        const r = this._activeFilterData
            , n = e.set(r.inputTexture._source.width, 0, 0, r.inputTexture._source.height, r.bounds.minX, r.bounds.minY)
            , a = t.worldTransform.copyTo(v.shared)
            , s = t.renderGroup || t.parentRenderGroup;
        return s && s.cacheToLocalTransform && a.prepend(s.cacheToLocalTransform),
            a.invert(),
            n.prepend(a),
    ...
    destroy() {
        var e;
        (e = this._passthroughFilter) == null || e.destroy(!0),
            this._passthroughFilter = null
    }
    _getPassthroughFilter() {
        return this._passthroughFilter ?? (this._passthroughFilter = new ut),
    ...
    _setupBindGroupsAndRender(e, t, r) {
        ...
        this._globalFilterBindGroup.setResource(t.source, 1),
            ...
            r.type === X.WEBGL && r.renderTarget.finishRenderPass()
    }
    _setupFilterTextures(e, t, r, n) {
        if (e.backTexture = P.EMPTY,
            e.inputTexture = b.getOptimalTexture(t.width, t.height, e.resolution, e.antialias),
            e.blendRequired) {
            r.renderTarget.finishRenderPass();
            const a = r.renderTarget.getRenderTarget(e.outputRenderSurface);
            e.backTexture = this.getBackTexture(a, t, n == null ? void 0 : n.bounds)
        }
    ...
    _calculateGlobalFrame(e, t, r, n, a, s) {
    ...
    _updateFilterUniforms(e, t, r, n, a, s, o, u) {
        const l = this._filterGlobalUniforms.uniforms
            ...
            , g = l.uGlobalFrame
            , x = l.uOutputTexture;
        o ? (h[0] = r.bounds.minX - n,
            h[1] = r.bounds.minY - a) : (h[0] = 0,
                h[1] = 0),
            h[2] = e.frame.width,
            h[3] = e.frame.height,
            c[0] = e.source.width,
            ...
            c[2] = 1 / c[0],
            c[3] = 1 / c[1],
            d[0] = e.source.pixelWidth,
            d[1] = e.source.pixelHeight,
            d[2] = 1 / d[0],
            d[3] = 1 / d[1],
            p[0] = .5 * d[2],
            p[1] = .5 * d[3],
            p[2] = e.frame.width * c[2] - .5 * d[2],
            p[3] = e.frame.height * c[3] - .5 * d[3];
        const y = this.renderer.renderTarget.rootRenderTarget.colorTexture;
        g[0] = n * s,
            g[1] = a * s,
            g[2] = y.source.width * s,
            g[3] = y.source.height * s,
            t instanceof P && (t.source.resource = null);
        const T = this.renderer.renderTarget.getRenderTarget(t);
        this.renderer.renderTarget.bind(t, !!u),
            t instanceof P ? (x[0] = t.frame.width,
                x[1] = t.frame.height) : (x[0] = T.width,
                    x[1] = T.height),
            x[2] = T.isRoot ? -1 : 1,
    ...
    _calculateFilterArea(e, t) {
        if (e.renderables ? lt(e.renderables, t) : e.filterEffect.filterArea ? (t.clear(),
    ...
    _applyFiltersToTexture(e, t) {
        const r = e.inputTexture
            , n = e.bounds
            , a = e.filters
            , s = e.firstEnabledIndex
            , o = e.lastEnabledIndex;
        if (this._globalFilterBindGroup.setResource(r.source.style, 2),
            ...
            s === o)
            a[s].apply(this, r, e.outputRenderSurface, t);
        else {
            let u = e.inputTexture;
            const l = b.getOptimalTexture(n.width, n.height, u.source._resolution, !1);
            let h = l;
            for (let c = s; c < o; c++) {
                const d = a[c];
                if (!d.enabled)
            ...
            a[o].apply(this, u, e.outputRenderSurface, t),
                b.returnTexture(l)
        }
    }
    _calculateFilterBounds(e, t, r, n, a) {
        var T;
        ...
        for (let C = 0; C < u.length; C++) {
            ...
            if (x === -1 && (x = C),
                y = C,
                l = Math.min(l, _.resolution === "inherit" ? n : _.resolution),
                h += _.padding,
                _.antialias === "off" ? c = !1 : _.antialias === "inherit" && c && (c = r),
                _.clipToViewport || (g = !1),
                !!!(_.compatibleRenderers & s.type)) {
                p = !1;
                break
            }
            if (_.blendRequired && !(((T = s.backBuffer) == null ? void 0 : T.useBackBuffer) ?? !0)) {
                L("Blend filter requires backBuffer on WebGL renderer to be enabled. Set `useBackBuffer: true` in the renderer options."),
                    p = !1;
                break
            }
            p = !0,
        ...
        if (g && o.fitBounds(0, t.width / n, 0, t.height / n),
            o.scale(l).ceil().scale(1 / l).pad((h | 0) * a),
            !o.isPositive) {
            e.skip = !0;
            return
        }
        e.antialias = c,
            e.resolution = l,
            e.blendRequired = d,
            e.firstEnabledIndex = x,
            e.lastEnabledIndex = y
    }
    _popFilterData() {
    ...
    _pushFilterData() {
        ...
        return e || (e = this._filterStack[this._filterStackIndex] = new dt),
...
class Ue {
    constructor() {
        this.svgRoot = document.createElementNS(ae, "svg"),
            this.foreignObject = document.createElementNS(ae, "foreignObject"),
...
function ht(i, e, t, r) {
    r || (r = ie || (ie = new Ue));
    const { domElement: n, styleElement: a, svgRoot: s } = r;
...
class N {
    ...
    get uvs() {
        ...
        return a.isSimple || (n = this._transformedUvs,
            (this._textureMatrixUpdateId !== a._updateID || this._uvUpdateId !== t._updateID) && ((!n || n.length < r.length) && (n = this._transformedUvs = new Float32Array(r.length)),
...
class Be {
    ...
    validateRenderable(e) {
        ...
        if (n) {
            ...
            return s.texture.uid !== e._texture.uid && (s._textureMatrixUpdateId = -1),
    ...
    addRenderable(e, t) {
        ...
        if (e.didViewUpdate && (n.indexSize = (a = e._geometry.indices) == null ? void 0 : a.length,
            n.vertexSize = (s = e._geometry.positions) == null ? void 0 : s.length),
            n.batched) {
    ...
    execute(e) {
        if (!e.isRenderable)
            return;
        e.state.blendMode = j(e.groupBlendMode, e.texture._source);
        ...
        t.uniforms.uTransformMatrix = e.groupTransform,
            ...
            t.update(),
            z(e.groupColorAlpha, t.uniforms.uColor, 0),
            this._adaptor.execute(this, e)
    }
    _getMeshData(e) {
        var t, r;
        return (t = e._gpuData)[r = this.renderer.uid] || (t[r] = new oe),
...
class pt {
    execute(e, t) {
        ...
        n.shader.bind(a),
            n.state.set(r),
            n.geometry.bind(o.geometry, a.glProgram);
        const l = o.geometry.indexBuffer.data.BYTES_PER_ELEMENT === 2 ? s.UNSIGNED_SHORT : s.UNSIGNED_INT;
...
class mt {
    execute(e, t) {
        ...
        n.groups[0] = r.renderPipes.uniformBatch.getUniformBindGroup(e.localUniforms, !0),
...
class xt {
    constructor(e) {
        ...
        for (const h in r) {
            const c = r[h]
                , d = W(c.format);
            c.dynamic ? a += d.stride : n += d.stride
        }
        this._dynamicStride = a / 4,
            this._staticStride = n / 4,
            this.staticAttributeBuffer = new U(t * 4 * n),
            this.dynamicAttributeBuffer = new U(t * 4 * a),
            this.indexBuffer = ue(t);
        const s = new me;
        let o = 0
            , u = 0;
        this._staticBuffer = new Z({
            data: new Float32Array(1),
            label: "static-particle-buffer",
            shrinkToFit: !1,
            usage: F.VERTEX | F.COPY_DST
        }),
            this._dynamicBuffer = new Z({
                data: new Float32Array(1),
        ...
        for (const h in r) {
            ...
            c.dynamic ? (s.addAttribute(c.attributeName, {
                ...
                o += d.size) : (s.addAttribute(c.attributeName, {
    ...
    update(e, t) {
        e.length > this._size && (t = !0,
            ...
            this.staticAttributeBuffer = new U(this._size * this._staticStride * 4 * 4),
            this.dynamicAttributeBuffer = new U(this._size * this._dynamicStride * 4 * 4),
            this.indexBuffer = ue(this._size),
        ...
        if (this._dynamicUpload(e, r.float32View, r.uint32View),
            ...
            this._staticUpload(e, n.float32View, n.uint32View),
                this._staticBuffer.setDataWithSize(n.float32View, e.length * this._staticStride * 4, !0)
        }
    }
    destroy() {
...
class Ge {
    constructor(e, t) {
        this.state = M.for2d(),
            ...
            this.renderer = e,
            this.adaptor = t,
            this.defaultShader = new bt,
            this.state = M.for2d(),
            this._managedContainers = new w({
                renderer: e,
                type: "renderable",
    ...
    _initBuffer(e) {
        return e._gpuData[this.renderer.uid] = new xt({
            size: e.particleChildren.length,
            properties: e._properties
        }),
            this._managedContainers.add(e),
    ...
    execute(e) {
        ...
        n.update(t, e._childrenDirty),
            e._childrenDirty = !1,
            a.blendMode = j(e.blendMode, e.texture._source);
        const s = this.localUniforms.uniforms
            , o = s.uTranslationMatrix;
        e.worldTransform.copyTo(o),
            o.prepend(r.globalUniforms.globalUniformData.projectionMatrix),
            s.uResolution = r.globalUniforms.globalUniformData.resolution,
            s.uRound = r._roundPixels | e._roundPixels,
            z(e.groupColorAlpha, s.uColor, 0),
...
class De {
    ...
    _initGPUSprite(e) {
        const t = e._gpuData[this._renderer.uid] = new vt
            , r = t;
...
class wt extends q {
    ...
    updateUniforms(e, t, r, n, a, s) {
        const o = this.resources.tilingUniforms
            , u = s.width
            , l = s.height
            , h = s.textureMatrix
            , c = o.uniforms.uTextureTransform;
        c.set(r.a * u / e, r.b * u / t, r.c * l / e, r.d * l / t, r.tx / e, r.ty / t),
            c.invert(),
            o.uniforms.uMapCoord = h.mapCoord,
            o.uniforms.uClampFrame = h.uClampFrame,
            o.uniforms.uClampOffset = h.uClampOffset,
            o.uniforms.uTextureTransform = c,
            o.uniforms.uSizeAnchor[0] = e,
            o.uniforms.uSizeAnchor[1] = t,
            o.uniforms.uSizeAnchor[2] = n,
            o.uniforms.uSizeAnchor[3] = a,
            s && (this.resources.uTexture = s.source,
...
function Ft(i, e) {
    ...
    let a = 0
        , s = 0;
    i.applyAnchorToTexture && (a = i.anchor.x,
        s = i.anchor.y),
        e[0] = e[6] = -a,
        e[2] = e[4] = 1 - a,
        e[1] = e[3] = -s,
...
class Ae {
    constructor(e) {
        this._state = M.default2d,
            this._renderer = e,
            this._managedTilingSprites = new w({
                renderer: e,
                type: "renderable",
                name: "tilingSprite"
            })
    ...
    addRenderable(e, t) {
        ...
        const n = this._getTilingSpriteData(e)
            , { geometry: a, canBatch: s } = n;
        if (s) {
            n.batchableMesh || (n.batchableMesh = new N);
    ...
    execute(e) {
        ...
        r.uTransformMatrix = e.groupTransform,
            ...
            z(e.groupColorAlpha, r.uColor, 0),
            this._state.blendMode = j(e.groupBlendMode, e.texture._source),
    ...
    _initTilingSpriteData(e) {
        ...
        return t.renderable = e,
            ...
            this._managedTilingSprites.add(e),
            t
    }
    _updateBatchableMesh(e) {
        ...
        n.addressMode !== "repeat" && (n.addressMode = "repeat",
            n.update()),
            Ft(e, r.uvs),
            Rt(e, r.positions)
    }
    ...
    _updateCanBatch(e) {
        const t = this._getTilingSpriteData(e)
            , r = e.texture;
        let n = !0;
        return this._renderer.type === X.WEBGL && (n = this._renderer.context.supports.nonPowOf2wrapping),
            t.canBatch = r.textureMatrix.isSimple && (n || r.source.isPowerOfTwo),
            t.canBatch
    }
}
Ae.extension = {
...
class At extends q {
    constructor(e) {
        ...
        O ?? (O = xe({
            name: "sdf-shader",
            bits: [Xe, $e(e), Gt, zt, _e]
        })),
            E ?? (E = ye({
                name: "sdf-shader",
                bits: [je, qe(e), Mt, Dt, Te]
            })),
            super({
                glProgram: E,
                gpuProgram: O,
...
class ke {
    constructor(e) {
        this._renderer = e,
            this._managedBitmapTexts = new w({
                renderer: e,
                type: "renderable",
                priority: -2,
                name: "bitmapText"
    ...
    _updateContext(e, t) {
        const { context: r } = t
            , n = Qe.getFont(e.text, e._style);
        r.clear(),
            n.distanceField.type !== "none" && (r.customShader || (r.customShader = new At(this._renderer.limits.maxBatchableTextures)));
        const a = Je.graphemeSegmenter(e.text)
            , s = e._style;
        ...
        const u = Ze(a, s, n, !0)
            ...
            , h = u.scale;
        let c = u.width
            , d = u.height + u.offsetY;
        s._stroke && (c += s._stroke.width / h,
            d += s._stroke.width / h),
            r.translate(-e._anchor._x * c - l, -e._anchor._y * d - l).scale(h, h);
        const p = n.applyFillAsTint ? s._fill.color : 16777215;
        let g = n.fontMetrics.fontSize
            , x = n.lineHeight;
        s.lineHeight && (g = s.fontSize / h,
            x = s.lineHeight / h);
        let y = (x - g) / 2;
        y - n.baseLineOffset < 0 && (y = 0);
        for (let T = 0; T < u.lines.length; T++) {
            const C = u.lines[T];
            for (let _ = 0; _ < C.charPositions.length; _++) {
                const Q = C.chars[_]
                    , S = n.chars[Q];
                if (S != null && S.texture) {
                    const D = S.texture;
                    r.texture(D, p || "black", Math.round(C.charPositions[_] + S.xOffset), Math.round(o + S.yOffset + y), D.orig.width, D.orig.height)
                }
            }
            o += x
        }
    ...
    initGpuText(e) {
        ...
        return e._gpuData[this._renderer.uid] = t,
            ...
            this._managedBitmapTexts.add(e),
            t
    }
    _updateDistanceField(e) {
        const t = this._getGpuBitmapText(e).context
            ...
            , n = H.get(`${r}-bitmap`)
            , { a, b: s, c: o, d: u } = e.groupTransform
            , l = Math.sqrt(a * a + s * s)
            , h = Math.sqrt(o * o + u * u)
            , c = (Math.abs(l) + Math.abs(h)) / 2
            , d = n.baseRenderedFontSize / e._style.fontSize
            , p = c * n.distanceField.range * (1 / d);
...
function K(i, e) {
    const { texture: t, bounds: r } = i
        , n = e._style._getFinalPadding();
    tt(r, e._anchor, t);
    const a = e._anchor._x * n * 2
        , s = e._anchor._y * n * 2;
    r.minX -= n - a,
        r.minY -= n - s,
        r.maxX -= n - a,
...
class Ie {
    ...
    addRenderable(e, t) {
        ...
        if (e._didTextUpdate) {
            ...
            (r.currentKey !== e.styleKey || e.resolution !== n) && this._updateGpuText(e).catch(a => {
                console.error(a)
            }
            ),
                e._didTextUpdate = !1,
    ...
    async _updateGpuText(e) {
        ...
        r && (n = n.finally(() => {
            ...
            t.texture = await n;
        const a = e.renderGroup || e.parentRenderGroup;
...
function Ot() {
    const { userAgent: i } = $.get().getNavigator();
...
function Oe(i, e, t, r) {
    ...
    n.minX = 0,
        ...
        n.maxX = i.width / r | 0,
        n.maxY = i.height / r | 0;
    const a = b.getOptimalTexture(n.width, n.height, r, !1);
...
async function Lt(i) {
    const t = await (await $.get().fetch(i)).blob()
        , r = new FileReader;
...
const V = new Map;
async function Yt(i) {
    const e = i.filter(t => H.has(`${t}-and-url`)).map(t => {
        if (!V.has(t)) {
            const { entries: r } = H.get(`${t}-and-url`)
                , n = [];
            r.forEach(a => {
                const s = a.url
                    , u = a.faces.map(l => ({
                ...
                V.set(t, Promise.all(n).then(a => a.join(`
`)))
        }
        return V.get(t)
    }
...
function Ht(i, e, t, r, n) {
    const { domElement: a, styleElement: s, svgRoot: o } = n;
    a.innerHTML = `<style>${e.cssStyle}</style><div style='padding:0;'>${i}</div>`,
        a.setAttribute("style", `transform: scale(${t});transform-origin: top left; display: inline-block`),
        s.textContent = r;
    const { width: u, height: l } = n.image;
    return o.setAttribute("width", u.toString()),
        o.setAttribute("height", l.toString()),
        new XMLSerializer().serializeToString(o)
}
function Kt(i, e) {
    const t = ve.getOptimalCanvasAndContext(i.width, i.height, e)
        , { context: r } = t;
...
class Ee {
    ...
    getManagedTexture(e) {
        ...
        const r = this._buildTexturePromise(e).then(n => (this._activeTextures[t].texture = n,
            n));
    ...
    async _buildTexturePromise(e) {
        const { text: t, style: r, resolution: n, textureStyle: a } = e
            , s = G.get(Ue)
            , o = Vt(t, r)
            , u = await Yt(o)
            , l = ht(t, r, u, s)
            , h = Math.ceil(Math.ceil(Math.max(1, l.width) + r.padding * 2) * n)
            , c = Math.ceil(Math.ceil(Math.max(1, l.height) + r.padding * 2) * n)
            , d = s.image
            , p = 2;
        d.width = (h | 0) + p,
            d.height = (c | 0) + p;
        const g = Ht(t, r, n, u, s);
        await Xt(d, g, Ot() && o.length > 0);
        const x = d;
        let y;
        this._createCanvas && (y = Kt(d, n));
        const T = Oe(y ? y.canvas : x, d.width - p, d.height - p, n);
        return a && (T.source.style = a),
            this._createCanvas && (this._renderer.texture.initSource(T.source),
                ve.returnCanvasAndContext(y)),
            G.return(s),
            T
    }
...
Ee.extension = {
    type: [f.WebGLSystem, f.WebGPUSystem, f.CanvasSystem],
    name: "htmlText"
};
class $t extends Ce {
}
class Ve {
    ...
    addRenderable(e, t) {
        ...
        if (e._didTextUpdate) {
            const n = e._autoResolution ? this._renderer.resolution : e.resolution;
            (r.currentKey !== e.styleKey || e.resolution !== n) && this._updateGpuText(e),
                e._didTextUpdate = !1,
                K(r, e)
        }
        this._renderer.renderPipes.batch.addToBatch(r, t)
...
class Le {
    ...
    getTexture(e, t, r, n) {
        typeof e == "string" && (ee("8.0.0", "CanvasTextSystem.getTexture: Use object TextOptions instead of separate arguments"),
            ...
            e.style instanceof te || (e.style = new te(e.style)),
            e.textureStyle instanceof Y || (e.textureStyle = new Y(e.textureStyle)),
            typeof e.text != "string" && (e.text = e.text.toString());
        const { text: a, style: s, textureStyle: o } = e
            , u = e.resolution ?? this._renderer.resolution
            , { frame: l, canvasAndContext: h } = A.getCanvasAndContext({
                text: a,
                style: s,
                resolution: u
            })
            , c = Oe(h.canvas, l.width, l.height, u);
        if (o && (c.source.style = o),
            s.trim && (l.pad(s.padding),
                c.frame.copyFrom(l),
                c.frame.scale(1 / u),
                c.updateUvs()),
            s.filters) {
    ...
    renderTextToCanvas() {
        ee("8.10.0", "CanvasTextSystem.renderTextToCanvas: no longer supported, use CanvasTextSystem.getTexture instead")
    }
    getManagedTexture(e) {
        e._resolution = e._autoResolution ? this._renderer.resolution : e.resolution;
        const t = e.styleKey;
