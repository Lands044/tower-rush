import { T as A, U as Z, P as g, r as te, E as b, b as ie, w as y, e as w, C as V } from "./index-qssFTiEP.js";
import "./webworkerAll-CSp3_19_.js";
import "./colorToUniform-BmEsojv1.js";
class q {
    constructor(e) {
        this._lastTransform = "",
            this._observer = null,
            ...
            this.updateTranslation = () => {
                ...
                const t = this._canvas.getBoundingClientRect()
                    ...
                    , r = t.left
                    , l = t.top
                    , d = `translate(${r}px, ${l}px) scale(${s}, ${o})`;
                d !== this._lastTransform && (this._domElement.style.transform = d,
                    this._lastTransform = d)
            }
            ,
        ...
        "ResizeObserver" in globalThis ? (this._observer && (this._observer.disconnect(),
            ...
            this._observer = new ResizeObserver(e => {
                for (const t of e) {
                    ...
                    (this._lastScaleX !== s || this._lastScaleY !== o) && (this.updateTranslation(),
                        this._lastScaleX = s,
                        this._lastScaleY = o)
                }
            }
    ...
    destroy() {
        this._observer ? (this._observer.disconnect(),
            this._observer = null) : this._tickerAttached && A.shared.remove(this.updateTranslation),
...
class O {
    constructor(e) {
        this.bubbles = !0,
            ...
            this.eventPhase = O.prototype.NONE,
    ...
    , L = class J {
        ...
        _deactivate() {
            ...
            if (!(!this._isActive || this._isMobileAccessibility)) {
                ...
                for (const i of this._children)
                    (e = i._accessibleDiv) != null && e.parentNode && (i._accessibleDiv.parentNode.removeChild(i._accessibleDiv),
                ...
                (t = this._div) != null && t.parentNode && this._div.parentNode.removeChild(this._div),
                    this._pools = {},
                    this._children = []
            }
        }
        ...
        init(e) {
            ...
            this.debug = i.accessibilityOptions.debug,
                ...
                i.accessibilityOptions.enabledByDefault && this._activate(),
                this._renderer.runners.postrender.remove(this)
        }
        postrender() {
            ...
            for (let i = this._children.length - 1; i >= 0; i--) {
                ...
                t.has(i) || (n._accessibleDiv && n._accessibleDiv.parentNode && (n._accessibleDiv.parentNode.removeChild(n._accessibleDiv),
                    this._getPool(n.accessibleType).push(n._accessibleDiv),
        ...
        _addChild(e) {
            ...
            i ? (i.innerHTML = "",
                ...
                i.tabIndex = 0) : (e.accessibleType === "button" ? i = document.createElement("button") : (i = document.createElement(e.accessibleType),
                    i.style.cssText = `
                        color: transparent;
                        pointer-events: none;
                        padding: 0;
                ...
                i.style.pointerEvents = e.accessiblePointerEvents,
                i.type = e.accessibleType,
                e.accessibleTitle && e.accessibleTitle !== null ? i.title = e.accessibleTitle : (!e.accessibleHint || e.accessibleHint === null) && (i.title = `container ${e.tabIndex}`),
                e.accessibleHint && e.accessibleHint !== null && i.setAttribute("aria-label", e.accessibleHint),
                e.interactive ? i.tabIndex = e.tabIndex : i.tabIndex = 0,
                this.debug && this._updateDebugHTML(i),
    ...
    postrender() {
        ...
        for (let t = 0; t < e.length; t++) {
            ...
            if (!i.parent || i.globalDisplayStatus < 7)
                ...
                this._domElement.contains(n) || (n.style.position = "absolute",
                ...
                const s = i.worldTransform
                    ...
                    , r = i.width * o.x
                    , l = i.height * o.y;
                n.style.transformOrigin = `${r}px ${l}px`,
                    n.style.transform = `matrix(${s.a}, ${s.b}, ${s.c}, ${s.d}, ${s.tx - r}, ${s.ty - l})`,
...
class ve {
    ...
    addTickerListener() {
        this._tickerAdded || !this.domElement || (A.system.add(this._tickerUpdate, this, Z.INTERACTION),
            this._tickerAdded = !0)
    }
    removeTickerListener() {
        this._tickerAdded && (A.system.remove(this._tickerUpdate, this),
            this._tickerAdded = !1)
    }
    pointerMoved() {
        this._didMove = !0
...
class _e {
    ...
    hitTest(e, t) {
        _.pauseUpdate = !0;
        const n = this._isPointerMoveEvent && this.enableGlobalMoveEvents ? "hitTestMoveRecursive" : "hitTestRecursive"
            , s = this[n](this.rootTarget, this.rootTarget.eventMode, me.set(e, t), this.hitTestFn, this.hitPruneFn);
        return s && s[0]
    }
    propagate(e, t) {
        if (!e.target)
    ...
    hitTestMoveRecursive(e, t, i, n, s, o = !1) {
        ...
        if (this._interactivePrune(e))
            return null;
        if ((e.eventMode === "dynamic" || t === "dynamic") && (_.pauseUpdate = !1),
            e.interactiveChildren && e.children) {
            const p = e.children;
            for (let u = p.length - 1; u >= 0; u--) {
                const h = p[u]
                    , v = this.hitTestMoveRecursive(h, this._isInteractive(t) ? t : h.eventMode, i, n, s, o || s(e, i));
                if (v) {
                    if (v.length > 0 && !v[v.length - 1].parent)
                        continue;
                    const c = e.isInteractive();
                    (v.length > 0 || c) && (c && this._allInteractiveElements.push(e),
                        v.push(e)),
        ...
        const l = this._isInteractive(t)
            , d = e.isInteractive();
        return d && d && this._allInteractiveElements.push(e),
            o || this._hitElements.length > 0 ? null : r ? this._hitElements : l && !s(e, i) && n(e, i) ? d ? [e] : [] : null
    }
    hitTestRecursive(e, t, i, n, s) {
        ...
        if ((e.eventMode === "dynamic" || t === "dynamic") && (_.pauseUpdate = !1),
            ...
            for (let p = l.length - 1; p >= 0; p--) {
                const u = l[p]
                    , h = this.hitTestRecursive(u, this._isInteractive(t) ? t : u.eventMode, d, n, s);
                if (h) {
                    if (h.length > 0 && !h[h.length - 1].parent)
                        continue;
                    const v = e.isInteractive();
                    return (h.length > 0 || v) && h.push(e),
                        h
                }
            }
        }
    ...
    hitPruneFn(e, t) {
        if (e.hitArea && (e.worldTransform.applyInverse(t, P),
            !e.hitArea.contains(P.x, P.y)))
            return !0;
    ...
    hitTestFn(e, t) {
        return e.hitArea ? !0 : e != null && e.containsPoint ? (e.worldTransform.applyInverse(t, P),
            e.containsPoint(P)) : !1
    }
    notifyTarget(e, t) {
        var s, o;
    ...
    mapPointerMove(e) {
        ...
        if (((l = n.overTargets) == null ? void 0 : l.length) > 0 && s !== t.target) {
            const p = e.type === "mousemove" ? "mouseout" : "pointerout"
                , u = this.createPointerEvent(e, p, s);
            if (this.dispatchEvent(u, "pointerout"),
        ...
        if (s !== t.target) {
            const p = e.type === "mousemove" ? "mouseover" : "pointerover"
                , u = this.clonePointerEvent(t, p);
        ...
        this.moveOnAll ? o.push("pointermove") : this.dispatchEvent(t, "pointermove"),
            ...
            t.pointerType === "touch" && (this.moveOnAll ? o.splice(1, 0, "touchmove") : this.dispatchEvent(t, "touchmove"),
                r && o.push("globaltouchmove")),
            i && (this.moveOnAll ? o.splice(1, 0, "mousemove") : this.dispatchEvent(t, "mousemove"),
                r && o.push("globalmousemove"),
                this.cursor = (d = t.target) == null ? void 0 : d.cursor),
    ...
    mapPointerUp(e) {
        ...
        if (o) {
            ...
            if (l.target === r.target && t - l.timeStamp < 200 ? ++l.clickCount : l.clickCount = 1,
                l.target = r.target,
                l.timeStamp = t,
                r.detail = l.clickCount,
                r.pointerType === "mouse") {
                const d = r.button === 2;
                this.dispatchEvent(r, d ? "rightclick" : "click")
            } else
                r.pointerType === "touch" && this.dispatchEvent(r, "tap");
            this.dispatchEvent(r, "pointertap"),
                this.freeEvent(r)
        }
        this.freeEvent(i)
    }
    ...
    copyPointerData(e, t) {
        e instanceof f && t instanceof f && (t.pointerId = e.pointerId,
            t.width = e.width,
            t.height = e.height,
    ...
    copyMouseData(e, t) {
        e instanceof D && t instanceof D && (t.altKey = e.altKey,
            t.button = e.button,
            t.buttons = e.buttons,
    ...
    , S = class x {
        constructor(e) {
            this.supportsTouchEvents = "ontouchstart" in globalThis,
                ...
                this._eventsAdded = !1,
                this._rootPointerEvent = new f(null),
                ...
                this.features = new Proxy({
                    ...
                    set: (t, i, n) => (i === "globalMove" && (this.rootBoundary.enableGlobalMoveEvents = n),
                        t[i] = n,
                        !0)
                }),
